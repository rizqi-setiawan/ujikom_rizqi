...
java.awt.EventQueue.invokeLater(new Runnable() {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // TODO add your handling code here:
        try {
          // string namafile ="VIEW/laporan/Lap_trans.jrxml");
            ...
            try {
                Map<String, Object>
                    ...
                    file  = new HOME ("src/laporan/Lap_trans.jrxml");
                JasperDesign jasDesign = JRXmlLoader.load(file);
                JasperReport jasReport = JasperCompileManager.compileReport(jasDesign);
                String jasprint = null;
                JasperPrint
                jasperPrint = net.sf.jasperreports.engine.JasperFillManager.fillReport ( jasReport,
                        parameter , koneksi.getConections());
